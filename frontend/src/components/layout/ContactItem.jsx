    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between mb-0.5">
          <span
            className={`text-sm font-semibold truncate ${isActive ? "text-white" : "text-gray-800"}`}
          >
            {contact.name}
          </span>
          <span
            className={`text-xs shrink-0 ml-1 ${isActive ? "text-sky-100" : "text-gray-400"}`}
          >
            {contact.lastTime}
          </span>
        </div>
        <div className="flex items-center justify-between">
          <p
            className={`text-xs truncate ${isActive ? "text-sky-100" : "text-gray-500"}`}
          >
            {contact.lastMessage}
          </p>
